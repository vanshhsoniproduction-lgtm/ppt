...
export default function RemotePage() {
  ...
  return (
    <div className="fixed inset-0 w-full h-[100dvh] bg-[#F2F2F7] text-[#1C1C1E] flex flex-col justify-between overflow-hidden select-none">
      {/* Header Bar */}
      <div className="glass-panel-light px-4 py-2 flex items-center justify-between z-30 border-b border-white flex-shrink-0">
      ...
      <div className="p-2 pb-5 landscape:pb-1 z-30 flex-shrink-0 w-full">
        <div className="glass-dock-light max-w-md mx-auto p-1.5 flex justify-around items-center border border-white shadow-xl">
          <button
            onClick={() => { triggerHaptic(); setActiveTab('nav'); }}
            className={`p-2.5 rounded-2xl flex flex-col items-center text-[9px] space-y-0.5 transition-all active:scale-95 ${activeTab === 'nav' ? 'bg-blue-500/15 text-blue-600 font-bold border border-blue-500/30' : 'text-slate-500'}`}
          >
          ...
          <button
            ...
            className={`p-2.5 rounded-2xl flex flex-col items-center text-[9px] space-y-0.5 transition-all active:scale-95 ${activeTab === 'zoom' ? 'bg-blue-500/15 text-blue-600 font-bold border border-blue-500/30' : 'text-slate-500'}`}
          >
          ...
          <button
            ...
            className={`p-2.5 rounded-2xl flex flex-col items-center text-[9px] space-y-0.5 transition-all active:scale-95 ${activeTab === 'effects' ? 'bg-purple-500/15 text-purple-600 font-bold border border-purple-500/30' : 'text-slate-500'}`}
          >
          ...
          <button
            ...
            className={`p-2.5 rounded-2xl flex flex-col items-center text-[9px] space-y-0.5 transition-all active:scale-95 ${activeTab === 'laser' ? 'bg-red-500/15 text-red-600 font-bold border border-red-500/30' : 'text-slate-500'}`}
          >
